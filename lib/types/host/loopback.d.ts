 ...
 * Host header, and browser same-origin markers. Maintained locally in
 * dsh-usage-plus (the historical scripts/sync-shared.mjs generator is not
 * part of this repo).
 *
 ...
 * @module dsh-usage-plus/host/loopback
 */
