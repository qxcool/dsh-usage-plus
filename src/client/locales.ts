...
export const zh = {
  ...
  'usage.config.externalHint': '外部源密钥只从 DSH 凭据库或环境变量读取：CPAMC_MANAGEMENT_KEY、VOLC_ACCESSKEY、VOLC_SECRETKEY。',
...
export const en: Record<UsageKey, string> = {
  ...
  'usage.config.externalHint': 'External secrets are read only from DSH credentials or environment variables: CPAMC_MANAGEMENT_KEY, VOLC_ACCESSKEY, VOLC_SECRETKEY.',
